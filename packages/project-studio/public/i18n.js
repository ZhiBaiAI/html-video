...
const DICT = {
  en: {
    ...
    'soundtrack.custom_voice_placeholder': 'Custom / cloned voice ID',
    ...
    'settings.audio.subtitle': 'Choose how narration is synthesized. Background music keeps using MiniMax directly.',
    ...
    'settings.audio.provider_bailian': 'Alibaba Cloud Model Studio · MiniMax',
    'settings.audio.model': 'Narration model',
    'settings.audio.bailian_key_placeholder': 'Paste your Model Studio API key',
    'settings.audio.clone_title': 'Clone a MiniMax voice',
    'settings.audio.clone_subtitle': 'Provide a public URL to a clean 10+ second MP3, M4A, or WAV recording. The voice is bound to the selected model.',
    'settings.audio.clone_name': 'Display name',
    'settings.audio.clone_name_placeholder': 'My narrator',
    'settings.audio.clone_id': 'Voice ID',
    'settings.audio.clone_audio_url': 'Public recording URL',
    'settings.audio.clone_preview_text': 'Preview text',
    'settings.audio.clone_preview_default': 'This is a preview of my cloned narration voice.',
    'settings.audio.clone_create': 'Create cloned voice',
    'settings.audio.clone_required': 'Voice ID, recording URL, and preview text are required.',
    ...
    'settings.audio.voice_library_note': 'MiniMax does not provide query or delete APIs through Model Studio. This list is stored locally; Remove only hides the voice from html-video.',
    ...
    'settings.audio.hint': 'Stored locally in .html-video/media-config.json. Bailian MiniMax TTS requires a Beijing-region Model Studio key. A cloned voice ID must match the selected model.',
  ...
  zh: {
    ...
    'soundtrack.custom_voice_placeholder': '自定义 / 复刻音色 ID',
    ...
    'settings.audio.subtitle': '选择旁白合成渠道；背景音乐仍保持 MiniMax 官方直连。',
    'settings.audio.loading': '检查中…',
    'settings.audio.api_key': 'API key',
    'settings.audio.provider': '旁白服务',
    'settings.audio.provider_minimax': 'MiniMax 官方',
    'settings.audio.provider_bailian': '阿里云百炼 · MiniMax',
    'settings.audio.model': '旁白模型',
    'settings.audio.bailian_key_placeholder': '粘贴百炼 API Key',
    'settings.audio.clone_title': '复刻 MiniMax 音色',
    'settings.audio.clone_subtitle': '填写一段公网可访问的清晰录音 URL，支持 MP3、M4A、WAV，时长至少 10 秒；音色会绑定当前所选模型。',
    'settings.audio.clone_name': '显示名称',
    'settings.audio.clone_name_placeholder': '我的旁白音色',
    'settings.audio.clone_id': '音色 ID',
    'settings.audio.clone_audio_url': '公网录音 URL',
    'settings.audio.clone_preview_text': '试听文案',
    'settings.audio.clone_preview_default': '这是我的复刻旁白音色试听。',
    'settings.audio.clone_create': '创建复刻音色',
    'settings.audio.clone_required': '请填写音色 ID、录音 URL 和试听文案。',
    ...
    'settings.audio.voice_library_note': '百炼 MiniMax 不提供音色查询和删除 API。这里保存的是本地清单；“移除”只会让音色不再显示在 html-video 中。',
    ...
    'settings.audio.hint': '配置保存在本地 .html-video/media-config.json。百炼 MiniMax TTS 需要北京地域的百炼 Key；复刻音色 ID 必须与所选模型一致。',
