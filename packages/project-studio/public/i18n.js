...
const DICT = {
  en: {
    ...
    'settings.agent.subtitle': 'Local Agent CLIs are detected automatically. Choose one, then use its default model or set a supported model ID; the saved project selection is used for generation.',
    ...
    'settings.agent.model_label': 'Model',
    'settings.agent.model_catalog_hint': 'Choose from the live model catalog provided by this Agent.',
    'settings.agent.model_custom_hint': 'Optional. Enter the exact model ID supported by this CLI; leave blank to use its own default.',
    'settings.agent.model_loading': 'Loading models…',
    'settings.agent.model_default': 'Leave blank for CLI default',
    'settings.agent.model_save': 'Save model',
    'settings.agent.model_saved': 'Model saved: {model}',
    'settings.agent.model_default_saved': 'Switched to the Agent CLI default model',
    ...
    'settings.agent.byok.intro': 'Configure API-backed models independently.',
    'settings.agent.byok.env_key': 'Legacy Anthropic environment variables remain supported.',
    'settings.agent.byok.env_base': 'New profiles are stored locally under .html-video.',
    'settings.agent.api.add_title': 'Add API model',
    'settings.agent.api.edit_title': 'Edit API model',
    'settings.agent.api.intro': 'Supports Alibaba Model Studio, DeepSeek, and other OpenAI-compatible Chat APIs.',
    'settings.agent.api.provider': 'Provider preset',
    'settings.agent.api.provider_dashscope': 'Alibaba Model Studio · Qwen',
    'settings.agent.api.provider_deepseek': 'DeepSeek',
    'settings.agent.api.provider_custom': 'Custom OpenAI-compatible API',
    'settings.agent.api.name': 'Display name',
    'settings.agent.api.base_url': 'Base URL',
    'settings.agent.api.model': 'Model ID',
    'settings.agent.api.key': 'API Key',
    'settings.agent.api.key_keep': 'Leave blank to keep the stored key',
    'settings.agent.api.storage_hint': 'Keys stay in the local, gitignored .html-video directory.',
    'settings.agent.api.save': 'Save and use',
    'settings.agent.api.update': 'Update',
    'settings.agent.api.saving': 'Saving…',
    'settings.agent.api.saved': 'API model saved: {name}',
    'settings.agent.api.loading': 'Loading API model configurations…',
    'settings.agent.api.cancel_edit': 'Cancel edit',
    'settings.agent.api.edit': 'Edit',
    'settings.agent.api.delete': 'Delete',
    'settings.agent.api.delete_confirm': 'Delete API model “{name}”?',
    'settings.agent.api.deleted': 'API model deleted',
  ...
  zh: {
    ...
    'settings.agent.title': 'Agent',
    'settings.agent.subtitle': '系统会自动检测本机已安装的 Agent CLI。选择 Agent 后，可以使用它的默认模型，也可以填写该 CLI 支持的模型 ID；项目会保存该选择，并在后续生成时真实使用。',
    ...
    'settings.agent.model_label': '模型',
    'settings.agent.model_catalog_hint': '从该 Agent 实时提供的模型列表中选择。',
    'settings.agent.model_custom_hint': '可选。填写该 CLI 实际支持的模型 ID；留空则使用 CLI 自己的默认配置。',
    'settings.agent.model_loading': '正在加载模型…',
    'settings.agent.model_default': '留空使用 CLI 默认模型',
    'settings.agent.model_save': '保存模型',
    'settings.agent.model_saved': '已保存模型：{model}',
    'settings.agent.model_default_saved': '已改为使用 Agent CLI 默认模型',
    ...
    'settings.agent.byok.intro': '可以独立配置由 API 驱动的模型。',
    'settings.agent.byok.env_key': '继续兼容已有的 Anthropic 环境变量配置。',
    'settings.agent.byok.env_base': '新增配置保存在本地 .html-video 目录。',
    'settings.agent.api.add_title': '添加 API 模型',
    'settings.agent.api.edit_title': '编辑 API 模型',
    'settings.agent.api.intro': '支持阿里云百炼、DeepSeek，以及其他兼容 OpenAI Chat 接口的服务。',
    'settings.agent.api.provider': '服务商预设',
    'settings.agent.api.provider_dashscope': '阿里云百炼 · 千问',
    'settings.agent.api.provider_deepseek': 'DeepSeek',
    'settings.agent.api.provider_custom': '自定义 OpenAI 兼容 API',
    'settings.agent.api.name': '显示名称',
    'settings.agent.api.base_url': 'Base URL',
    'settings.agent.api.model': '模型 ID',
    'settings.agent.api.key': 'API Key',
    'settings.agent.api.key_keep': '留空则保留已保存的 Key',
    'settings.agent.api.storage_hint': 'Key 只保存在本机已忽略提交的 .html-video 目录。',
    'settings.agent.api.save': '保存并使用',
    'settings.agent.api.update': '更新配置',
    'settings.agent.api.saving': '正在保存…',
    'settings.agent.api.saved': '已保存 API 模型：{name}',
    'settings.agent.api.loading': '正在加载 API 模型配置…',
    'settings.agent.api.cancel_edit': '取消编辑',
    'settings.agent.api.edit': '编辑',
    'settings.agent.api.delete': '删除',
    'settings.agent.api.delete_confirm': '删除 API 模型“{name}”？',
    'settings.agent.api.deleted': 'API 模型已删除',
