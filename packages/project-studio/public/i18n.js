...
const DICT = {
  en: {
    ...
    'narrate.title': '🎬 Narrate to video',
    'narrate.subtitle': 'Paste a script or give a topic — the agent writes the storyboard, voices it, and exports a narrated MP4 in one go.',
    ...
    'narrate.start': '🎬 Start narrate',
    'narrate.cancel': 'Cancel',
    'narrate.agent_required': 'Select an agent in the toolbar first.',
    ...
    'narrate.done': '✓ Narrated video exported · {seconds}s',
    'narrate.done_no_seconds': '✓ Narrated video exported',
  ...
  zh: {
    ...
    // 一键口播出片
    'narrate.title': '🎬 一键口播出片',
    'narrate.subtitle': '粘贴口播文案或输入主题 —— agent 自动生成分镜、配音、导出带旁白的 MP4。',
    ...
    'narrate.start': '🎬 开始口播出片',
    'narrate.cancel': '取消',
    'narrate.agent_required': '请先在工具栏选择 agent。',
    ...
    'narrate.done': '✓ 口播视频已导出 · {seconds}秒',
    'narrate.done_no_seconds': '✓ 口播视频已导出',
